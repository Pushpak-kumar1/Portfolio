...
export default function About() {
  return (
    ...
    <div 
        ...
        <p>
            Hello, I'm Pushpak, a passionate Web Developer with a keen eye for MERN Stack. With a background in IT, I strive to create impactful and visually stunning Software solution that leave a lasting impression.
        </p>
        <br />
